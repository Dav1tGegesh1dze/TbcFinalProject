 ...
 */
public abstract class Hilt_AdDetailFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_AdDetailFragment(Function1<? super LayoutInflater, ? extends VB> bindingInflater) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdDetailFragment_GeneratedInjector) this.generatedComponent()).injectAdDetailFragment(UnsafeCasts.<AdDetailFragment>unsafeCast(this));
    }
  }
