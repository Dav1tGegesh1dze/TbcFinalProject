 ...
 */
public abstract class Hilt_OrderConfirmationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OrderConfirmationFragment() {
    super();
  }

  Hilt_OrderConfirmationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrderConfirmationFragment_GeneratedInjector) this.generatedComponent()).injectOrderConfirmationFragment(UnsafeCasts.<OrderConfirmationFragment>unsafeCast(this));
    }
  }
