 ...
 */
public abstract class Hilt_RestaurantFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_RestaurantFragment(Function1<? super LayoutInflater, ? extends VB> bindingInflater) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RestaurantFragment_GeneratedInjector) this.generatedComponent()).injectRestaurantFragment(UnsafeCasts.<RestaurantFragment>unsafeCast(this));
    }
  }
