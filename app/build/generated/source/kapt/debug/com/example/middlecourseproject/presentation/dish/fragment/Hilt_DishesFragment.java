 ...
 */
public abstract class Hilt_DishesFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_DishesFragment(Function1<? super LayoutInflater, ? extends VB> bindingInflater) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DishesFragment_GeneratedInjector) this.generatedComponent()).injectDishesFragment(UnsafeCasts.<DishesFragment>unsafeCast(this));
    }
  }
